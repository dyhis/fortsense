...
namespace ImGui
{
	...
	IMGUI_API bool          BeginComboBackground(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0);
	IMGUI_API bool          BeginEndBorder(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0);
	...
	IMGUI_API bool          BeginTabs(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API bool          BeginTabs(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API void          EndTabs();

	IMGUI_API bool          EndBorder(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API bool          EndBorder(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API void          EndEndBorder();

	IMGUI_API bool          BeginShadow(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API bool          BeginShadow(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API void          EndShadow();

	IMGUI_API bool          BeginGroupBox(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API bool          BeginGroupBox(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API void          EndGroupBox();

	IMGUI_API bool          BeginGroupBoxScroll(const char* str_id, const char* groupboxName, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API bool          BeginGroupBoxScroll(ImGuiID id, const char* groupboxName, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
	IMGUI_API void          EndGroupBoxScroll();
	...
	IMGUI_API void			PushColor(ImGuiCol idx, ImGuiCol idx2, const ImVec4& col);
	...
	IMGUI_API bool          SelectedTab(const char* label, const ImVec2& size = ImVec2(0, 0));    // selected tab
	IMGUI_API bool          Tab(const char* label, const ImVec2& size = ImVec2(0, 0));    // tab
	IMGUI_API bool          TabSpacer(const char* label, const ImVec2& size = ImVec2(0, 0));    // TabSpacer
	IMGUI_API bool          TabSpacer2(const char* label, const ImVec2& size = ImVec2(0, 0));    // TabSpacer2
	IMGUI_API bool          GroupBoxTitle(const char* label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          TabButton(const char* label, const ImVec2& size = ImVec2(0, 0));    // tab button
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0));    // button
	IMGUI_API bool          ColorBar(const char* label, const ImVec2& size = ImVec2(0, 0));    // ColorBar
	IMGUI_API bool			QuitButton(const char* label, const ImVec2& size = ImVec2(0, 0));    // quit button
	IMGUI_API bool          NoInputButton(const char* label, const ImVec2& size = ImVec2(0, 0));    // button without input
...
inline ImFont* boldMenuFont;
 ...
 inline ImFont* test_font;
 inline ImFont* watermark_font;
 inline ImFont* legit_icons;
